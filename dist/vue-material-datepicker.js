...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DatepickerAgenda = __webpack_require__(11);

	var _DatepickerAgenda2 = _interopRequireDefault(_DatepickerAgenda);
	...
	exports.default = {
	    components: {
	        'datepicker-agenda': _DatepickerAgenda2.default
	    },
	    props: {
	    ...
	    computed: {
	        date_formatted: function date_formatted() {
	            if (this.date) return this.date.format(this.format);
	            return '';
	        },
	        date_raw: function date_raw() {
	    ...
	    methods: {
	        ...
	        showDatepicker: function showDatepicker() {
	            ...
	            this.isVisible = true;
	            setTimeout(function () {
	                return document.addEventListener('click', _this.hideDatePicker);
	            }, 0);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/DatepickerAgenda.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./DatepickerAgenda.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./DatepickerAgenda.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	    ...
	    watch: {
	        show: function show(val, oldval) {
	            if (val === false) {
	                ...
	                var newDate = (0, _moment2.default)([this.date.year(), this.date.month(), this.date.date()]);
	        ...
	        yearsVisible: function yearsVisible(val, oldval) {
	            var scrollOffset = (this.date.year() - this.years[0].year()) * 40 - 130;
	    ...
	    ready: function ready() {
	        ...
	        this.$nextTick(function () {
	            _this.setMonths();
	            _this.years = _this.months[0].getYears();
	        });
	    },

	    methods: {
	        classYear: function classYear(year) {
	            if (year.year() == this.date.year()) return 'selected';else return '';
	        },
	        ...
	        selectYear: function selectYear(date) {
	            ...
	            var newDate = (0, _moment2.default)([date.year(), this.date.month(), this.date.date()]);
	            this.date = newDate.clone();

	            var scrollOffset = (this.date.year() - this.years[0].year()) * 40 - 130;
	            $('.datepicker-years').animate({ scrollTop: scrollOffset }, '100', function () {
	                _this2.showOrHideYears();
	            });
	        },
	        setClassDirection: function setClassDirection(date) {
	            this.dayDirection = 'direction-next';
	            if (date.isBefore(this.date)) this.dayDirection = 'direction-prev';
	        },
	        setMonths: function setMonths() {
	            var newMonths = [];
	            var firstMonth = new _month2.default(this.date.month(), this.date.year());
	            newMonths.push(firstMonth);

	            if (this.doubled) {
	                var mon = this.date.month() + 1;
	                ...
	                var secondMonth = new _month2.default(mon, year);
	        ...
	        nextMonth: function nextMonth() {
	            var tmpMonths = [];
	            var monthsLength = this.months.length - 1;

	            for (var i = 0; i < monthsLength; i++) {
	                tmpMonths.push(this.months[i]);
	            }

	            var mon = this.months[monthsLength].month + 1;
	            var year = this.months[monthsLength].year;
	            ...
	            var tmpMonth = new _month2.default(mon, year);
	        ...
	        showOrHideYears: function showOrHideYears() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var momentRange = __webpack_require__(36);
